...
<!-- Special Products section starts-->
		<div class="section outdiv" id="specialities">
    	  ...
    	  <div class="col-md-12">
    				...
    				<p class="sub-headers text-center">PRODUCTS</p>
...
<?php
$t=$_SESSION["regn"];
$res=mysqli_query($db,"SELECT * FROM product WHERE registration= '$t'");
$n=0;
...
?>
  ...
  <div class="spe-prods">
					<div class="mainbox">
						<h3><a href="userinfo.php?prod_id=<?php echo $r["prod_id"]?>"><?php echo $r["prod_name"];?></a></h3>
                        <img class="rotprod" src="<?php echo $r["images_path"];?>" height="60" width="145"  alt="">
					</div>
					<div class="price-big">
						<div>
					...
					<button name="delbtn" class="btn btn-primary delbtn" id="<?php echo $r["prod_id"];?>" value="Delete">Delete</button>
				</div>
      ...
      $.ajax({
       ...
       data:{
       	id:id
             ...
             {
             	alert('Item deleted');
             	header('Location: http://localhost/mnnitekart/dell.php');
             }
       }
      });
  });
