...
$res=mysqli_query($db,"SELECT * FROM product WHERE prod_id= '$prod_id' ");
$res=mysqli_fetch_array($res,MYSQLI_ASSOC);

?>
						<li data-thumb="<?php echo $res["images_path"];?>">
							<div class="thumb-image"> <img src="<?php echo $res["images_path"];?>" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
			...
			<div class="col-md-8 single-right">
				...
				<div class="description">
					...
					<p><?php echo "Description :  ".$res["description"];?></p>
				</div>
				
					
				<div class="simpleCart_shelfItem">
					<p><i class="item_price"><?php echo "Price :  ".$res["price"]; ?></i></p>
					
				</div> 

				<div class="description">
					<h5><i>Owner Information</i></h5>
<?php
$t=mysqli_query($db,"SELECT * FROM users WHERE registration=(SELECT registration FROM product WHERE prod_id='$prod_id')");
$res2=mysqli_fetch_array($t,MYSQLI_ASSOC);
?>

<p><?php echo "Name :  ".$res2["fname"];
echo " ".$res2["lname"];?></p>

<?php
$t=mysqli_query($db,"SELECT * FROM contact WHERE registration=(SELECT registration FROM product WHERE prod_id='$prod_id')");
$res2=mysqli_fetch_array($t,MYSQLI_ASSOC);
?>

<?php
echo "Room No :  ".$res2["roomno"];
?>
<p>
	<?php
echo "Hostel :  ".$res2["hostel"];?>
<p>
	<?php
echo "Phone :  ".$res2["phone"];?>
